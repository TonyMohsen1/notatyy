...
class Database {
  constructor() {
    ...
    this.Url= "mongodb+srv://admin:admin123@cluster0.bghky.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0";
  }
 ...
 /*
  connect() {
    mongoose
      .connect(this.Url) // بدون options
      .then(() => {
        console.log("Connected to db");
      })
      .catch((err) => {
        console.log("Error received when connecting to db:", err);
      });
  }*/
